...
trigger a workflow. The OMO config should register the compatibility command,
and the generated prompt should contain the `ulw-loop` continuation directive.
