        ...
        use)
            ...
            if [ "_${NVM_CURRENT}" = '_none' ] || [ "_${NVM_CURRENT}" = '_system' ]; then
                ...
                if [ -n "${VERSION}" ]; then
                    ...
                    if nvm_rc_version 3> /dev/null > /dev/null 2>&1; then
...
{ 
    ...
    do
        if [ -d "$FILE" ]; then
            ...
            if [ -e "$FILE" ] && [ ! -w "$FILE" ] && [ -z "$(command find "${FILE}" -prune -user "$(command id -u)")" ]; then
...
{ 
    ...
    if nvm_has_executable "curl"; then
        ...
        if nvm_has_executable "wget"; then
            NVM_DOWNLOADER='wget';
...
{ 
    ...
    if [ "$(command uname)" = "Linux" ] && [ "${NVM_ARCH}" = arm64 ] && [ "$(command od -An -t x1 -j 4 -N 1 "/sbin/init" 2> /dev/null)" = ' 01' ]; then
        NVM_ARCH=armv7l;
        HOST_ARCH=armv7l;
    fi;
...
declare -x ACTIONS_ORCHESTRATION_ID="ce3efe6e-a9f6-44d5-aace-a84260dc5d4d.codex.codex.__default"
...
declare -x AGENTSWEB_PUBLIC_KEY="ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIAgIH1DLlM3jG2izqKYH/P49PVCnkl6TsF9fzkxiAmJb aiplay-agentsweb-mac"
...
declare -x CI="true"
declare -x CODEX_ENDPOINT="ws://127.0.0.1:4097"
declare -x CODEX_HOME="/home/runner/work/OhMyGithub/OhMyGithub/.codex-worker/home"
declare -x CODEX_MANAGED_BY_NPM="1"
declare -x CODEX_MANAGED_PACKAGE_ROOT="/opt/hostedtoolcache/node/22.23.2/x64/lib/node_modules/@openai/codex"
declare -x CODEX_STATE_DIR="/home/runner/work/OhMyGithub/OhMyGithub/.codex-worker"
declare -x CODEX_WEB_CREDENTIAL=""
...
declare -x GH_TOKEN="ghs_15368_eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJhdXRobmQiLCJjdHgiOiJrQy05RUQ5bldMeUdHbFZJSjFhRXBRSWlPSVNDekhvd3kxZFVmWk5RN1JmdWZVZ2hTdzJ0a0Z3IiwiZXhwIjoxNzg4OTMwMDg0LCJpYXQiOjE3ODg5MjY0ODQsImlzcyI6ImdpdGh1YiIsImp0aSI6IjY5MjI3NzJlLWM5YzctNDM0Zi04ZDdkLWIwMzgzZjY4ZmVjMSIsInZlciI6M30.EYFlJ1HGk2eNTOCHrAzoztzwaRLgGc9yBPzzOCIAxIw8yYxEWHvoBUk_vmxL95lwn-74Umjlm88LF6qvokaJ9A"
declare -x GITHUB_ACTION="__run"
declare -x GITHUB_ACTIONS="true"
declare -x GITHUB_ACTION_REF=""
declare -x GITHUB_ACTION_REPOSITORY=""
declare -x GITHUB_ACTOR="agents-dev"
declare -x GITHUB_ACTOR_ID="306679077"
declare -x GITHUB_API_URL="https://api.github.com"
declare -x GITHUB_ARTIFACTS="/home/runner/work/_temp/_runner_file_commands/artifacts_c04ceff4-e777-4f4c-b5bb-9f04cb943c6c"
declare -x GITHUB_ARTIFACTS_LIST="/home/runner/work/_temp/_runner_file_commands/artifacts_list_c04ceff4-e777-4f4c-b5bb-9f04cb943c6c"
declare -x GITHUB_BASE_REF=""
declare -x GITHUB_ENV="/home/runner/work/_temp/_runner_file_commands/set_env_c04ceff4-e777-4f4c-b5bb-9f04cb943c6c"
...
declare -x GITHUB_JOB="codex"
declare -x GITHUB_OUTPUT="/home/runner/work/_temp/_runner_file_commands/set_output_c04ceff4-e777-4f4c-b5bb-9f04cb943c6c"
declare -x GITHUB_PATH="/home/runner/work/_temp/_runner_file_commands/add_path_c04ceff4-e777-4f4c-b5bb-9f04cb943c6c"
declare -x GITHUB_REF="refs/heads/codex/add-codex-agent"
declare -x GITHUB_REF_NAME="codex/add-codex-agent"
declare -x GITHUB_REF_PROTECTED="false"
declare -x GITHUB_REF_TYPE="branch"
declare -x GITHUB_REPOSITORY="AgentsLoop/OhMyGithub"
declare -x GITHUB_REPOSITORY_ID="1343274046"
declare -x GITHUB_REPOSITORY_OWNER="AgentsLoop"
declare -x GITHUB_REPOSITORY_OWNER_ID="318478564"
declare -x GITHUB_RETENTION_DAYS="90"
declare -x GITHUB_RUN_ATTEMPT="1"
declare -x GITHUB_RUN_ID="34309288740"
declare -x GITHUB_RUN_NUMBER="242"
declare -x GITHUB_SERVER_URL="https://github.com"
declare -x GITHUB_SHA="0cd35e766d2db6a4c302f7a28ab0e6d7afcb6f89"
declare -x GITHUB_STATE="/home/runner/work/_temp/_runner_file_commands/save_state_c04ceff4-e777-4f4c-b5bb-9f04cb943c6c"
declare -x GITHUB_STEP_SUMMARY="/home/runner/work/_temp/_runner_file_commands/step_summary_c04ceff4-e777-4f4c-b5bb-9f04cb943c6c"
declare -x GITHUB_TRIGGERING_ACTOR="agents-dev"
declare -x GITHUB_WORKFLOW="Coding agents"
declare -x GITHUB_WORKFLOW_REF="AgentsLoop/OhMyGithub/.github/workflows/opencode.yml@refs/heads/codex/add-codex-agent"
declare -x GITHUB_WORKFLOW_SHA="0cd35e766d2db6a4c302f7a28ab0e6d7afcb6f89"
declare -x GITHUB_WORKSPACE="/home/runner/work/OhMyGithub/OhMyGithub"
declare -x GOROOT_1_24_X64="/opt/hostedtoolcache/go/1.24.13/x64"
declare -x GOROOT_1_25_X64="/opt/hostedtoolcache/go/1.25.14/x64"
declare -x GOROOT_1_26_X64="/opt/hostedtoolcache/go/1.26.7/x64"
declare -x GRADLE_HOME="/usr/share/gradle-9.7.1"
declare -x HCA_CLOUD_PROVIDER="azure"
declare -x HOME="/home/runner"
declare -x HOMEBREW_CLEANUP_PERIODIC_FULL_DAYS="3650"
declare -x HOMEBREW_NO_AUTO_UPDATE="1"
declare -x INVOCATION_ID="c7daee5a8fec4c71983d2ab4ad23f368"
declare -x ISSUE_TITLE="Smoke test browser terminal"
declare -x ImageOS="ubuntu24"
declare -x ImageVersion="20260831.293.1"
...
declare -x JOURNAL_STREAM="9:8795"
declare -x LABELS_JSON="[\"failed\",\"Codex\"]"
...
declare -x PATH="/home/runner/work/OhMyGithub/OhMyGithub/.codex-worker/home/tmp/arg0/codex-arg0z7RD6o:/opt/hostedtoolcache/node/22.23.2/x64/lib/node_modules/@openai/codex/node_modules/@openai/codex-linux-x64/vendor/x86_64-unknown-linux-musl/codex-path:/home/runner/work/OhMyGithub/OhMyGithub/.codex-worker:/opt/hostedtoolcache/node/22.23.2/x64/bin:/snap/bin:/home/runner/.local/bin:/opt/pipx_bin:/home/runner/.cargo/bin:/home/runner/.config/composer/vendor/bin:/usr/local/.ghcup/bin:/home/runner/.dotnet/tools:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin"
...
declare -x PROJECT_PATH="./"
declare -x PSModulePath="/root/.local/share/powershell/Modules:/usr/local/share/powershell/Modules:/opt/microsoft/powershell/7/Modules:/usr/share/az_15.6.1"
declare -x REQUEST="Create a file named codex-workflow-smoke.txt containing exactly: Codex workflow smoke test. Then verify the file exists and return a final response."
declare -x RUNNER_ARCH="X64"
declare -x RUNNER_ENVIRONMENT="github-hosted"
declare -x RUNNER_NAME="GitHub Actions 1000000358"
declare -x RUNNER_OS="Linux"
declare -x RUNNER_TEMP="/home/runner/work/_temp"
declare -x RUNNER_TOOL_CACHE="/opt/hostedtoolcache"
declare -x RUNNER_TRACKING_ID="github_deab2c16-6e14-4d82-8aef-ca8ebff1e3e1"
declare -x RUNNER_WORKSPACE="/home/runner/work/OhMyGithub"
declare -x RUNTIME_DIR="/home/runner/work/OhMyGithub/OhMyGithub/.omgithub-runtime"
...
declare -x SYSTEMD_EXEC_PID="1946"
declare -x TARGET_SHA="0cd35e766d2db6a4c302f7a28ab0e6d7afcb6f89"
declare -x TEST_REQUEST="false"
declare -x TRIGGER_ISSUE_NUMBER="222"
