<template>
  <div class="app-shell">
    <header class="topbar">
      ...
      <nav class="topnav"><a href="/#discover">Discover</a><RouterLink to="/todo">Todo</RouterLink><a href="https://github.com/AgentsLoop/OhMyGithub" target="_blank">GitHub</a></nav>
