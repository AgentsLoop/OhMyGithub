<template>
  <div class="app-shell">
    <header class="topbar">
      ...
      <nav class="topnav"><a href="/#discover">Discover</a><RouterLink to="/play/moonlit-parcel-dash" style="color:#ff6719;font-weight:700">🌙 Moonlit Dash</RouterLink><a href="https://github.com/AgentsLoop/OhMyGithub" target="_blank">GitHub</a></nav>
